...
describe("TODO REMOVE TEST BUNDLE", () => {
  ...
  it("add two, then remove two from the list", async () => {
    ...
    const TODOListDeleteButtonAfterDeletion = screen.getAllByRole("button", {
      name: /delete/i,
    });
    expect(TODOListDeleteButtonAfterDeletion.length).toBe(1);

    fireEvent.click(TODOListDeleteButtonAfterDeletion[0]);
